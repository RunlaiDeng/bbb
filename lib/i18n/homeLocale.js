...
const en = {
  ...
  idoEndedSwitchHint: "The IDO has ended. Switch to BSC to enter the new BBBFI home.",
  switchToBsc: "Switch to BSC",
  connectAndSwitchToBsc: "Connect wallet to switch to BSC",
  switchingToBsc: "Switching to BSC",
...
const zh = {
  ...
  idoEnded: "IDO 已结束。",
  idoEndedSwitchHint: "IDO 已结束。切换到 BSC 链进入新的 BBBFI 首页。",
  switchToBsc: "切换到 BSC 链",
  connectAndSwitchToBsc: "连接钱包并切换到 BSC 链",
  switchingToBsc: "正在切换到 BSC 链",
