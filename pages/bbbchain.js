    ...
    <div className="min-h-screen bg-gradient-to-b from-primary/10 to-green-100">
      ...
      <div className="container mx-auto px-4 py-10 md:py-20">
        <div className="text-center animate-fade-in">
          ...
          <p className="text-lg md:text-2xl text-success mb-6 md:mb-8 animate-slide-up delay-200 px-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4 md:gap-8">
          <div className="card bg-base-200 shadow-xl transition-transform duration-300 hover:scale-105">
            <div className="card-body p-4 md:p-8">
              <svg className="w-12 h-12 md:w-16 md:h-16 text-primary mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
              </svg>
              <h2 className="card-title text-lg md:text-xl text-green-800 justify-center mt-2">Instant Payments</h2>
              <p className="text-center text-sm md:text-base text-success">Process payments in milliseconds with our high-performance network</p>
            </div>
          </div>
          ...
          <div className="card bg-base-200 shadow-xl transition-transform duration-300 hover:scale-105">
            <div className="card-body p-4 md:p-8">
              ...
              <p className="text-center text-sm md:text-base text-success">Minimal transaction fees for efficient value transfer</p>
            </div>
          </div>
          ...
          <div className="card bg-base-200 shadow-xl transition-transform duration-300 hover:scale-105">
            <div className="card-body p-4 md:p-8">
              ...
              <p className="text-center text-sm md:text-base text-success">Advanced AI algorithms ensure secure and reliable transactions</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-b from-green-700 to-green-800 py-12 md:py-20">
        <div className="container mx-auto px-4 text-center">
          <div className="animate-slide-up-delayed">
            ...
            <button className="btn btn-lg bg-base-200 text-success hover:bg-primary/10 border-none transform transition-all duration-300 hover:scale-105 hover:shadow-lg">
              Stay Updated
            </button>
          </div>
        </div>
