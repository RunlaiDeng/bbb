...
import {
  DynamicTokenChartFun,
  DynamicTokenChartPool,
  DynamicTokenChat,
  DynamicTokenInfo,
  DynamicTokenMarkets,
  DynamicTokenSwapFun,
  DynamicTokenTradeFun,
      ...
      <div className="m-auto grid lg:grid-cols-5 gap-4 lg:h-[960px] p-2">
        ...
        <div className="lg:col-span-3 bg-white rounded-2xl shadow-lg overflow-x-auto text-center">
          ...
          {!graduate && (
            <>
              <div className="h-[300px] lg:h-[450px]">
                {type == "chart" && <DynamicTokenChartFun {...tChartFun} />}
                {type == "info" && <DynamicTokenInfo {...tInfo} />}
                {type == "chat" && <DynamicTokenChat {...tChat} />}
                {type == "trades" && <DynamicTokenTradeFun {...tTradeFun} />}
                {type == "markets" && <DynamicTokenMarkets {...tMarkets} />}
              </div>
              <div className="divider my-1"></div>
              <div className=" bg-gradient-to-br from-emerald-50 to-green-50 rounded-xl m-4 border border-green-100">
                <DynamicTokenSwapFun {...tSwapFun} />
              </div>
            </>
          )}
        </div>
        {windowWidth > 1024 && (
          <div className="bg-white rounded-2xl shadow-lg p-4 text-center overflow-y-auto">
            {graduate ? (
              ...
              <DynamicTokenTradeFun {...tTradeFun} />
            )}
          </div>
        )}
      </div>
