    ...
    mount && (
      <div className="m-auto md:w-3/4 w-96 mt-2 pb-1">
        ...
        <div className="bg-gradient-to-br from-primary/90 via-base-300 to-base-200 rounded-2xl shadow-xl p-8 mb-8 text-white text-center transform hover:scale-[1.02] transition-all duration-300">
          ...
          <button
            className="btn bg-base-200 text-primary hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300"
            onClick={() => {
        ...
        <div className="bg-base-200 rounded-2xl shadow-lg p-8 mb-8 hover:shadow-xl transition-all duration-300">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-gradient-to-br from-primary/10 to-base-200 p-6 rounded-xl border border-primary/20">
              <p className="text-sm font-medium text-base-content/60 mb-2">Friends</p>
              <p className="text-3xl font-bold text-primary">
                {referralData.shareFee || 0}%
              </p>
            </div>
            <div className="bg-gradient-to-br from-primary/10 to-base-200 p-6 rounded-xl border border-primary/20">
              <p className="text-sm font-medium text-base-content/60 mb-2">Mine</p>
              <p className="text-3xl font-bold text-primary">
        ...
        <div className="bg-base-200 rounded-2xl shadow-lg p-8 mb-8 hover:shadow-xl transition-all duration-300">
          ...
          <div className="space-y-4">
            <label
              className="input input-bordered flex items-center gap-2 cursor-pointer w-full bg-base-200/60 hover:bg-base-300 transition-colors"
              onClick={() => {
                copy(address);
            ...
            >
              ...
              <svg
                ...
                width="20"
                height="20"
                className="ml-auto text-base-content/40 hover:text-base-content/60"
              >
                <path
                ...
                {referralData.underline?.map((item) => {
                  return (
                    ...
                    >
                      <td className="flex items-center gap-2">
                        <Image height={16} width={16} src="/bbb.jpg" alt={""} />
                        <span className="text-base-content/70">{item.account}</span>
                      </td>
                      <td className="text-base-content/70">
                        {Number(
