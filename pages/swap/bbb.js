...
const BBB = () => {
  ...
  const token = "0xFa4dDcFa8E3d0475f544d0de469277CF6e0A6Fd1";
  const pool = "0x2340cd5ec3e6c51c217212f5092d56d594f0bd0e";
  const icecreamswap = "0x2a9a2D31819cD71B60F25729Bc60a2D7E7545233";
  ...
  async function fetchData() {
    ...
    const kline = await getKline(pool);
    ...
    setData({ ...data, ...setPrice, kline: kline?.reverse() });
  }
  ...
  const allowance = reads0?.[2]?.result;
  const name = "Beny Bad Boy";
  const symbol = "BBB";
  const imageUrl = "/bbb.jpg";
  const description = "dropToken?.description";
  const website = "https://bbbpump.fun";
  const telegram = "https://t.me/bbbpump";
  const twitter = "https://x.com/bbbpumpdotfun";
  const index = "BBB";
                  ...
                  <div className="mt-4 sm:mt-0">
                    <div className="text-xl flex gap-2 items-center">
                      ...
                      <div
                        ...
                        onClick={(e) => {
                          window.open(
                            "https://coinmarketcap.com/currencies/beny-bad-boy/"
                          );
                        }}
                      >
                        <svg
                    ...
                    <div className="opacity-50 mt-1 h-20 overflow-auto">
                      The Benybadboy (BBB) token is a community-driven memecoin
                      project developed on the XDC blockchain.
                    </div>
