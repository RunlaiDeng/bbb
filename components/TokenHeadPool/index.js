...
const TokenHead = (props) => {
  ...
  return (
    <div className="card mx-0 py-0 bg-transparent shadow-none border-none">
      <div className="card-body p-0 whitespace-nowrap">
        <div className="flex gap-4 text-left items-center font-semibold flex-wrap tabular-nums">
          ...
          <div className="hidden lg:block">
            ...
            <div
              className={
                "text-xs " +
                (h24Change >= 0 ? "text-success" : "text-error")
              }
            >
